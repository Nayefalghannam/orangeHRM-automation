...
it.only('orangeHRM process' , function(){
...
cy.login() //this is the same as the login above but used now as method, in the commands
//-------------------------------------------------------------------
...
cy.get(':nth-child(4) > .oxd-input-group > :nth-child(2) > .oxd-input').type('Timothy1234567' , {delay: 200}) // insert a username in the username box
...
cy.get(':nth-child(2) > .oxd-input').type('Timothy1234567' , {delay: 200}) // insert the username of existing employee
...
cy.wait(5000) // wait afterv the search for 5 seconds
...
//  //-----------
//  cy.get(':nth-child(2) > .oxd-input').type('Senior Project Manager2' , {delay: 200}) // insert the job title with delay 0.3 sec
...
// removeing Job title
//  cy.get('.oxd-table-body').should('contain', 'Senior Project Manager2').then(() => cy.log('Job title verified'));
//     cy.wait(4000);
//     // First find the exact row containing your job title and scrollview
//     cy.contains('.oxd-table-row', 'Senior Project Manager2' , {delay: 200} )
//         .scrollIntoView({ duration: 200 })
//         .should('exist')
//         .within(() => {
//             // checkbox click
...
cy.logout() //this is the log out method

}) // end

//login employee 
// add remove employee
//add remove job title
//personal info 